...
int lpit0_ch0_flag_counter = 0; /* LPIT0 타임아웃 카운터를 0으로 초기화시킵니다. */
...
void PORT_init(void)
{
    ...
    */
    ...
    PTD->PDDR |= 1 << PTD1 | 1 << PTD2 | 1 << PTD3 | 1 << PTD4 | 1 << PTD5 | 1 << PTD6 | 1 << PTD7 | 1 << PTD10 |
                 1 << PTD11; /* Port D1-D7: Data Direction= output (default) */
    ...
    하게 됩니다. -위 두번째 코드는 PTD10~11핀을 FND 제어설정하는 것을 나타냅니다. 즉, 이 핀든 FND에 데이터를 출력하는
    역할을 하게 됩니다.
    */
