...
int main(void)
{
    ...
    char msg_array1[16] = {0x48, 0x45, 0x4C, 0x4C, 0x4F, 0x5F, 0x53, 0x54,
                           0x55, 0x44, 0x45, 0x4E, 0x54, 0x53, 0x21}; // 1-row text-char
    char msg_array2[16] = {0x48, 0x45, 0x52, 0x45, 0x27, 0x53, 0x20, 0x4F,
                           0x4D, 0x52, 0x4F, 0x42, 0x21, 0x5E, 0x5E}; // 2-row text-char
